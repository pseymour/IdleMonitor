    ...
    public class Shutdown
    {
        ...
        */
        ...
        public static void PerformShutdownAction(ShutdownFlag flag, bool force)
        {
            ...
            UserIdleMonitor.NativeMethods.WTSLogoffSession(UserIdleMonitor.NativeMethods.WTS_CURRENT_SERVER_HANDLE, UserIdleMonitor.NativeMethods.WTS_CURRENT_SESSION, false);
        }
        */
